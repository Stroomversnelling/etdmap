...
if __name__ == "__main__":
    ...
    # by the different imputation steps in etdmap
    # used for testing. Needs te be run only when the behaviour
    # of etdmap has changed and the output is checked carefully.

    store_sample_and_metadata_for_all_transformed_files(etdmap.options.mapped_folder_path)
